...
set "TABLES=vBadges vComments vLinkTypes vPostLinks vPostTypes vPosts vUsers vVoteTypes vVotes"
...
for %%T in (%TABLES%) do (
    ...
    "C:\Program Files\7-Zip\7z.exe" a -tgzip D:\csv\!BCP_EXPORT_TABLE!.csv.gz D:\csv\!BCP_EXPORT_TABLE!.csv

    del D:\csv\HeadersOnly.csv
    del D:\csv\TableDataWithoutHeaders.csv
    del D:\csv\!BCP_EXPORT_TABLE!.csv
)
